 ...
 */
@SymbolName("Konan_FloatingPointParser_parseDblImpl")
private external fun parseDblImpl(s: String, e: Int): Double
 ...
 * *                if the String doesn't represent a positive integer value
 */
@SymbolName("Konan_FloatingPointParser_parseFltImpl")
private external fun parseFltImpl(s: String, e: Int): Float
...
object FloatingPointParser {
    ...
    private class StringExponentPair internal constructor(internal var s: String, internal var e: Int, internal var negative: Boolean)
     ...
     */
    private fun parseDblName(namedDouble: String, length: Int): Double {
  ...
  * Assumes the string is trimmed.
  */
    private fun parseFltName(namedFloat: String, length: Int): Float {
        // Valid strings are only +Nan, NaN, -Nan, +Infinity, Infinity,
        // -Infinity.
        if (length != 3 && length != 4 && length != 8 && length != 9) {
            throw NumberFormatException()
